...
This repository is the HTML example application: a fully styled reference app demonstrating every catalog component.
...
```sh
git clone https://github.com/LilyDesignSystem/lily-design-system-html-css-js-examples.git
cd lily-design-system-html-css-js-examples
npm install
npm run dev
```
